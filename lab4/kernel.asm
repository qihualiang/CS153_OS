...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 28 79 10 80 	movl   $0x80107928,(%esp)
...
80102e55:	e8 a6 3e 00 00       	call   80106d00 <shminit>
  tvinit();        // trap vectors
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e98:	c7 04 24 28 79 10 80 	movl   $0x80107928,(%esp)
...
80105249:	e8 12 1b 00 00       	call   80106d60 <shm_open>
}
8010524e:	c9                   	leave  
8010524f:	c3                   	ret    
    return -1;
...
8010683e:	c7 04 24 2c 79 10 80 	movl   $0x8010792c,(%esp)
...
80106c95:	83 ec 10             	sub    $0x10,%esp
  ...
  mem = kalloc();
80106c98:	e8 13 b8 ff ff       	call   801024b0 <kalloc>
  if (mem == 0) {
80106c9d:	85 c0                	test   %eax,%eax
  mem = kalloc();
80106c9f:	89 c3                	mov    %eax,%ebx
  if (mem == 0) {
80106ca1:	74 25                	je     80106cc8 <kmalloc+0x38>
    cprintf("allocuvm out of memory! \n");
    deallocuvm(pgdir, newsz, oldsz);
    return 0;
  }
  memset(mem, 0, PGSIZE);
80106ca3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106caa:	00 
80106cab:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106cb2:	00 
80106cb3:	89 04 24             	mov    %eax,(%esp)
80106cb6:	e8 d5 d5 ff ff       	call   80104290 <memset>
  return mem;
}
80106cbb:	83 c4 10             	add    $0x10,%esp
80106cbe:	89 d8                	mov    %ebx,%eax
80106cc0:	5b                   	pop    %ebx
80106cc1:	5e                   	pop    %esi
80106cc2:	5d                   	pop    %ebp
80106cc3:	c3                   	ret    
...
80106cc8:	8b 45 0c             	mov    0xc(%ebp),%eax
    cprintf("allocuvm out of memory! \n");
80106ccb:	c7 04 24 10 79 10 80 	movl   $0x80107910,(%esp)
  uint newsz = oldsz + PGSIZE;
80106cd2:	8d b0 00 10 00 00    	lea    0x1000(%eax),%esi
    cprintf("allocuvm out of memory! \n");
80106cd8:	e8 73 99 ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106cdd:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106ce0:	73 d9                	jae    80106cbb <kmalloc+0x2b>
80106ce2:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106ce5:	89 f2                	mov    %esi,%edx
80106ce7:	8b 45 08             	mov    0x8(%ebp),%eax
80106cea:	e8 01 f7 ff ff       	call   801063f0 <deallocuvm.part.0>
80106cef:	eb ca                	jmp    80106cbb <kmalloc+0x2b>
...
80106d06:	c7 44 24 04 50 79 10 	movl   $0x80107950,0x4(%esp)
80106d0d:	80 
80106d0e:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d15:	e8 46 d3 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106d1a:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d21:	e8 2a d4 ff ff       	call   80104150 <acquire>
80106d26:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106d2b:	90                   	nop
...
80106d40:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for (i = 0; i< 64; i++) {
80106d47:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106d4c:	75 e2                	jne    80106d30 <shminit+0x30>
  }
  release(&(shm_table.lock));
80106d4e:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
...
80106d65:	be f4 54 11 80       	mov    $0x801154f4,%esi
80106d6a:	53                   	push   %ebx
  ...
  for (i = 0; i < 64; i++) {
80106d6b:	31 db                	xor    %ebx,%ebx
int shm_open(int id, char **pointer) {
80106d6d:	83 ec 2c             	sub    $0x2c,%esp
...
80106d7d:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106d80:	eb 21                	jmp    80106da3 <shm_open+0x43>
...
80106d88:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
  for (i = 0; i < 64; i++) {
80106d8f:	83 c3 01             	add    $0x1,%ebx
80106d92:	83 c6 0c             	add    $0xc,%esi
    release(&(shm_table.lock));
80106d95:	e8 a6 d4 ff ff       	call   80104240 <release>
  for (i = 0; i < 64; i++) {
80106d9a:	83 fb 40             	cmp    $0x40,%ebx
80106d9d:	0f 84 85 00 00 00    	je     80106e28 <shm_open+0xc8>
    acquire(&(shm_table.lock));
80106da3:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106daa:	e8 a1 d3 ff ff       	call   80104150 <acquire>
    if (shm_table.shm_pages[i].id == id) {
80106daf:	39 3e                	cmp    %edi,(%esi)
80106db1:	75 d5                	jne    80106d88 <shm_open+0x28>
      shm_table.shm_pages[i].refcnt ++;
80106db3:	8d 34 5b             	lea    (%ebx,%ebx,2),%esi
80106db6:	c1 e6 02             	shl    $0x2,%esi
      release(&(shm_table.lock));
80106db9:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
      shm_table.shm_pages[i].refcnt ++;
80106dc0:	83 86 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%esi)
      release(&(shm_table.lock));
80106dc7:	e8 74 d4 ff ff       	call   80104240 <release>
      sz = PGROUNDUP(sz);
80106dcc:	8b 5d e0             	mov    -0x20(%ebp),%ebx
80106dcf:	81 c3 ff 0f 00 00    	add    $0xfff,%ebx
      if (mappages(curproc->pgdir, (char*) sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0) {
80106dd5:	8b 86 f8 54 11 80    	mov    -0x7feeab08(%esi),%eax
      sz = PGROUNDUP(sz);
80106ddb:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
      if (mappages(curproc->pgdir, (char*) sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0) {
80106de1:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106de8:	00 
80106de9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106df0:	00 
80106df1:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106df5:	05 00 00 00 80       	add    $0x80000000,%eax
80106dfa:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106dfe:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106e01:	8b 40 04             	mov    0x4(%eax),%eax
80106e04:	89 04 24             	mov    %eax,(%esp)
80106e07:	e8 44 f7 ff ff       	call   80106550 <mappages>
80106e0c:	85 c0                	test   %eax,%eax
80106e0e:	0f 88 9d 00 00 00    	js     80106eb1 <shm_open+0x151>
      sz = PGROUNDUP(sz);
      if (mappages(curproc->pgdir, (char*) sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0) {
        cprintf("allocuvm out of memory! \n");
        return -1;
...
80106e1b:	83 c4 2c             	add    $0x2c,%esp
80106e1e:	5b                   	pop    %ebx
80106e1f:	5e                   	pop    %esi
80106e20:	5f                   	pop    %edi
80106e21:	5d                   	pop    %ebp
...
80106e24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (i = 0; i < 64; i++) {
80106e28:	30 db                	xor    %bl,%bl
80106e2a:	eb 18                	jmp    80106e44 <shm_open+0xe4>
80106e2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    release(&(shm_table.lock));
80106e30:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
  for (i = 0; i < 64; i++) {
80106e37:	83 c3 01             	add    $0x1,%ebx
    release(&(shm_table.lock));
80106e3a:	e8 01 d4 ff ff       	call   80104240 <release>
  for (i = 0; i < 64; i++) {
80106e3f:	83 fb 40             	cmp    $0x40,%ebx
80106e42:	74 63                	je     80106ea7 <shm_open+0x147>
    acquire(&(shm_table.lock));
80106e44:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e4b:	e8 00 d3 ff ff       	call   80104150 <acquire>
80106e50:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
80106e53:	8d 34 85 00 00 00 00 	lea    0x0(,%eax,4),%esi
    if (shm_table.shm_pages[i].id == 0) {
80106e5a:	8b 04 85 f4 54 11 80 	mov    -0x7feeab0c(,%eax,4),%eax
80106e61:	85 c0                	test   %eax,%eax
80106e63:	75 cb                	jne    80106e30 <shm_open+0xd0>
      shm_table.shm_pages[i].frame = kmalloc(curproc->pgdir, sz);
80106e65:	8b 5d e0             	mov    -0x20(%ebp),%ebx
80106e68:	8b 45 e4             	mov    -0x1c(%ebp),%eax
      shm_table.shm_pages[i].id = id;
80106e6b:	89 be f4 54 11 80    	mov    %edi,-0x7feeab0c(%esi)
      shm_table.shm_pages[i].frame = kmalloc(curproc->pgdir, sz);
80106e71:	89 5c 24 04          	mov    %ebx,0x4(%esp)
      sz = PGROUNDUP(sz);
80106e75:	8d 9b ff 0f 00 00    	lea    0xfff(%ebx),%ebx
      shm_table.shm_pages[i].frame = kmalloc(curproc->pgdir, sz);
80106e7b:	8b 40 04             	mov    0x4(%eax),%eax
80106e7e:	89 04 24             	mov    %eax,(%esp)
80106e81:	e8 0a fe ff ff       	call   80106c90 <kmalloc>
      release(&(shm_table.lock));
80106e86:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
      shm_table.shm_pages[i].refcnt = 1;
80106e8d:	c7 86 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%esi)
80106e94:	00 00 00 
      shm_table.shm_pages[i].frame = kmalloc(curproc->pgdir, sz);
80106e97:	89 86 f8 54 11 80    	mov    %eax,-0x7feeab08(%esi)
      release(&(shm_table.lock));
80106e9d:	e8 9e d3 ff ff       	call   80104240 <release>
80106ea2:	e9 2e ff ff ff       	jmp    80106dd5 <shm_open+0x75>
return -1; //added to remove compiler warning -- you should decide what to return
80106ea7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106eac:	e9 6a ff ff ff       	jmp    80106e1b <shm_open+0xbb>
        cprintf("allocuvm out of memory! \n");
80106eb1:	c7 04 24 10 79 10 80 	movl   $0x80107910,(%esp)
80106eb8:	e8 93 97 ff ff       	call   80100650 <cprintf>
        return -1;
80106ebd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ec2:	e9 54 ff ff ff       	jmp    80106e1b <shm_open+0xbb>
...
//you write this too!
  ...
  for (i = 0; i < 64; i++) {
    acquire(&(shm_table.lock));
80106ed6:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106edd:	e8 6e d2 ff ff       	call   80104150 <acquire>

    if (shm_table.shm_pages[i].id == id) {
80106ee2:	8b 45 08             	mov    0x8(%ebp),%eax
80106ee5:	39 05 f4 54 11 80    	cmp    %eax,0x801154f4
      shm_table.shm_pages[i].refcnt --;
80106eeb:	a1 fc 54 11 80       	mov    0x801154fc,%eax
    if (shm_table.shm_pages[i].id == id) {
80106ef0:	74 2e                	je     80106f20 <shm_close+0x50>
    }
    if (shm_table.shm_pages[i].refcnt == 0) {
80106ef2:	85 c0                	test   %eax,%eax
80106ef4:	75 14                	jne    80106f0a <shm_close+0x3a>
      shm_table.shm_pages[i].id = 0;
80106ef6:	c7 05 f4 54 11 80 00 	movl   $0x0,0x801154f4
80106efd:	00 00 00 
      shm_table.shm_pages[i].frame = 0;
80106f00:	c7 05 f8 54 11 80 00 	movl   $0x0,0x801154f8
80106f07:	00 00 00 
    }
    break;
  }
...
80106f11:	e8 2a d3 ff ff       	call   80104240 <release>
...
80106f1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      shm_table.shm_pages[i].refcnt --;
80106f20:	83 e8 01             	sub    $0x1,%eax
80106f23:	a3 fc 54 11 80       	mov    %eax,0x801154fc
80106f28:	eb c8                	jmp    80106ef2 <shm_close+0x22>
